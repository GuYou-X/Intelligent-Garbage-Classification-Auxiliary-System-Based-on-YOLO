...
PLOT_SAVE_PATH = r"D:\DeepLearning\ultralytics-8.3.163\Garbage_Classification_Detection\my_train\cleaned_garbage_datasets_analysis_plots"
...
def plot_train_val_distribution(class_counts, split_counts):
    ...
    ax.set_title("类别分布图", fontsize=14, weight="bold")
    ax.set_xlabel("Class")
    ax.set_ylabel("数量")
    ax.set_xticks(x)
    ...
    save_path = os.path.join(PLOT_SAVE_PATH, "classes_count_stats.png")
...
def plot_class_table(class_counts, split_counts):
    ...
    save_path = os.path.join(PLOT_SAVE_PATH, "classes_count_table.png")
